export const NFTProgramId = 'Aleo_Art_Istanbul_Collection.aleo';

export const NFTProgram = `program Aleo_Art_Istanbul_Collection.aleo;
...
function initialize_collection:
    ...
    assert.eq self.caller aleo14evj2378w2dav7e0wtytr3ng2j5u0ana20jz3ljr25huz9rr0cpqs6muw5;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as Aleo_Art_Istanbul_Collection.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as Aleo_Art_Istanbul_Collection.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as Aleo_Art_Istanbul_Collection.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as Aleo_Art_Istanbul_Collection.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as Aleo_Art_Istanbul_Collection.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as Aleo_Art_Istanbul_Collection.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as Aleo_Art_Istanbul_Collection.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as Aleo_Art_Istanbul_Collection.aleo/open_mint.future;
...
function mint:
    ...
    output r7 as Aleo_Art_Istanbul_Collection.aleo/mint.future;
...
function claim_nft:
    ...
    output r6 as Aleo_Art_Istanbul_Collection.aleo/claim_nft.future;
...
function authorize:
    ...
    output r2 as Aleo_Art_Istanbul_Collection.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as Aleo_Art_Istanbul_Collection.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as Aleo_Art_Istanbul_Collection.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as Aleo_Art_Istanbul_Collection.aleo/convert_public_to_private.future;
